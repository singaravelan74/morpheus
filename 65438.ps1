...
$deploycloud = "<%= customOptions.fnDeployCloud %>"
$ApplicationLocation = "<%= customOptions.fnAppLocation %>"
$Application = "<%= customOptions.fnApplication %>"
$AppPriOwner = "<%= customOptions.fnAppPriOwner %>"
$AppSecOwner = "<%= customOptions.fnAppSecOwner %>"
$AppScope = "Global"
$AppCategory = "Infra"
$AppCLLevel = "CL4"
